...
def getModel(I, training):
  ...
  # (8x64x64)
  res_tmp = res.pop()
  # O = tf_trunc_as(O, res_tmp)
  O = tf.concat([O, res_tmp], axis=-1, name='Concat_1')
  # (8x64x128)
  O = upsample(O, 180, 90, (3,5), (2,2), training, name='upsample_4')
  # (16x128x64)
  res_tmp = res.pop()
  # O = tf_trunc_as(O, res_tmp)
  O = tf.concat([O, res_tmp], axis=-1, name='Concat_2')
  # (16x128x128)
  O = upsample(O, 180, 90, (3,5), (2,2), training, name='upsample_3')
  # (32x256x64)
  res_tmp = res.pop()
  # O = tf_trunc_as(O, res_tmp)
  O = tf.concat([O, res_tmp], axis=-1, name='Concat_3')
  # (32x256x128)
  O = upsample(O, 180, 45, (5,7), (2,2), training, name='upsample_2')
  # (64x512x32)
  res_tmp = res.pop()
  # O = tf_trunc_as(O, res_tmp)
  O = tf.concat([O, res_tmp], axis=-1, name='Concat_4')
  # (64x512x64)
